...
has a tab called \ct{tab2} with a row called \ct{A1} with the value 12.  
Then entering:
...
Suppose the workspace \ct{process.ws} has a tab called \ct{tab2}, loads
an image in \ct{A1}, performs some processing and produces a result image
\ct{A10}. If you run \nip{} with:
