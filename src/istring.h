...
#define STRING( obj ) (G_TYPE_CHECK_INSTANCE_CAST( (obj), TYPE_STRING, String ))
#define STRING_CLASS( klass ) \
	(G_TYPE_CHECK_CLASS_CAST( (klass), TYPE_STRING, StringClass ))
#define IS_STRING( obj ) (G_TYPE_CHECK_INSTANCE_TYPE( (obj), TYPE_STRING ))
#define IS_STRING_CLASS( klass ) \
	(G_TYPE_CHECK_CLASS_TYPE( (klass), TYPE_STRING ))
