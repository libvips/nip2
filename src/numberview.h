...
#define NUMBERVIEW( obj ) (G_TYPE_CHECK_INSTANCE_CAST( (obj), TYPE_NUMBERVIEW, Numberview ))
#define NUMBERVIEW_CLASS( klass ) \
	(G_TYPE_CHECK_CLASS_CAST( (klass), TYPE_NUMBERVIEW, NumberviewClass ))
#define IS_NUMBERVIEW( obj ) (G_TYPE_CHECK_INSTANCE_TYPE( (obj), TYPE_NUMBERVIEW ))
#define IS_NUMBERVIEW_CLASS( klass ) \
	(G_TYPE_CHECK_CLASS_TYPE( (klass), TYPE_NUMBERVIEW ))
