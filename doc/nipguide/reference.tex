...
called \ct{main.def} (you need the \ct{.def} suffix) containing:
...
\noindent
Where \ct{A1} is the name of the row in your workspace that you want to save,
and \ct{myworkspace} is the name of your workspace. Now run \nip{} with:
...
load \ct{myworkspace.ws}, and save the value of \ct{A1} to \ct{fred.jpg} (the
\ct{-p} switch).
