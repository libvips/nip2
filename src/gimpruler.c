...
/* GimpUnit stuff removed for nip3.
 */
      ...
      if (priv->orientation == GTK_ORIENTATION_HORIZONTAL)
        {
          ...
          x = rint ((position - lower) * increment) + (border.left - bs_width) / 2 - 1;
      ...
      else
        {
          ...
          y = rint ((position - lower) * increment) + (border.top - bs_height) / 2 - 1;
        }
