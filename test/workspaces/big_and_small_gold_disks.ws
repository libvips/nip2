...
<root xmlns="http://www.vips.ecs.soton.ac.uk/nip/7.19.0">
  <Workspace window_x="0" window_y="0" window_width="1280" window_height="975" filename="big_and_small_gold_disks.ws" view="WORKSPACE_MODE_REGULAR" scale="1" offset="0" lpane_position="0" lpane_open="false" rpane_position="1274" rpane_open="false" local_defs="// private definitions for this workspace&#10;summit in mask = class Image value {&#10;value = im_compass in mask;&#10;}&#10;&#10;main = A2;" name="big_and_small_gold_disks" caption="Default empty workspace">
    ...
    <Column x="6314" y="0" open="true" selected="false" sform="false" next="60" name="T" caption="(SMALL) disk average minus lowest average over each ring octant">
      <Subcolumn vislevel="3">
    ...
    <Column x="4856" y="0" open="true" selected="false" sform="false" next="20" name="N" caption="(SMALL) ring octants convolution matrices">
      <Subcolumn vislevel="3">
    ...
    <Column x="5710" y="0" open="true" selected="false" sform="false" next="15" name="O" caption="(SMALL) ring convolutions">
      <Subcolumn vislevel="3">
    ...
    <Column x="3576" y="0" open="true" selected="false" sform="false" next="15" name="D" caption="(SMALL) octant mask">
      <Subcolumn vislevel="3">
        ...
        <Row popup="false" name="D9">
          <Rhs vislevel="2" flags="5">
            ...
            <Subcolumn vislevel="0"/>
            <iText formula="if D6 &amp; D12 then 1 else if D6 then 2 else 0"/>
          </Rhs>
        </Row>
      </Subcolumn>
    </Column>
    <Column x="6969" y="0" open="true" selected="false" sform="false" next="12" name="R" caption="(SMALL) centroids (computed with an indexed histogram)">
      <Subcolumn vislevel="3">
    ...
    <Column x="7467" y="0" open="true" selected="false" sform="false" next="29" name="G" caption="(SMALL) draw squares at centroid locations">
      <Subcolumn vislevel="3">
    ...
    <Column x="7936" y="0" open="true" selected="false" sform="false" next="10" name="I" caption="(SMALL) plot 3x3 green squares on image with blue disks at big disk locations">
      <Subcolumn vislevel="3">
    ...
    <Column x="750" y="66" open="true" selected="false" sform="false" next="7" name="E" caption="FINAL IMAGE RESULT with small nanoparticles tagged with a 3x3 green square and big disks tagged with a blue disk">
      <Subcolumn vislevel="3">
        <Row popup="false" name="E1">
          <Rhs vislevel="1" flags="1">
            <iImage window_x="0" window_y="25" window_width="1278" window_height="722" image_left="622" image_top="330" image_mag="1" show_status="false" show_paintbox="false" show_convert="false" show_rulers="true" scale="1" offset="0" falsecolour="false" type="true"/>
            <Subcolumn vislevel="0"/>
    ...
    <Column x="0" y="1840" open="true" selected="false" sform="false" next="2" name="L" caption="(SMALL) number of regions">
      <Subcolumn vislevel="3">
    ...
    <Column x="2568" y="0" open="true" selected="false" sform="false" next="3" name="B" caption="(SMALL) &quot;dark enough&quot; test">
      <Subcolumn vislevel="3">
    ...
    <Column x="0" y="1555" open="true" selected="false" sform="false" next="5" name="C" caption="(SMALL) darker in most directions combined with dark at the center">
      <Subcolumn vislevel="3">
    ...
    <Column x="0" y="1141" open="true" selected="false" sform="false" next="4" name="F" caption="(SMALL) THRESHOLD for &quot;dark enough&quot; test (useable range: 0.-255.)">
      <Subcolumn vislevel="3">
    ...
    <Column x="0" y="529" open="true" selected="false" sform="false" next="2" name="P" caption="(SMALL) NUMBER of directions to ignore in the &quot;darker in all but n directions&quot; test (useable range: 0-7)">
      <Subcolumn vislevel="3">
    ...
    <Column x="0" y="934" open="true" selected="false" sform="false" next="11" name="U" caption="(BIG) THRESHOLD for &quot;darker in all but n directions&quot; (useable range: 0.-255.)">
      <Subcolumn vislevel="3">
    ...
    <Column x="12223" y="0" open="true" selected="false" sform="false" next="59" name="W" caption="(BIG) disk average minus each ring wedge average">
      <Subcolumn vislevel="3">
    ...
    <Column x="10786" y="0" open="true" selected="false" sform="false" next="20" name="X" caption="(BIG) ring octants masks">
      <Subcolumn vislevel="3">
    ...
    <Column x="11630" y="0" open="true" selected="false" sform="false" next="15" name="Y" caption="(BIG) ring wedge averages">
      <Subcolumn vislevel="3">
    ...
    <Column x="9507" y="0" open="true" selected="false" sform="false" next="15" name="Z" caption="(BIG) octant masks">
      <Subcolumn vislevel="3">
    ...
    <Column x="12874" y="0" open="true" selected="false" sform="false" next="13" name="AB" caption="(BIG) region centroids (computed with indexed histogram)">
      <Subcolumn vislevel="3">
    ...
    <Column x="13513" y="0" open="true" selected="false" sform="false" next="29" name="BB" caption="(BIG) put small disks centered at centroids">
      <Subcolumn vislevel="3">
    ...
    <Column x="14135" y="0" open="true" selected="false" sform="false" next="10" name="CB" caption="(BIG) plot small blue dots on original">
      <Subcolumn vislevel="3">
    ...
    <Column x="0" y="2335" open="true" selected="false" sform="false" next="2" name="EB" caption="(BIG) number of regions">
      <Subcolumn vislevel="3">
    ...
    <Column x="8525" y="0" open="true" selected="false" sform="false" next="3" name="GB" caption="(BIG) &quot;dark enough&quot; test">
      <Subcolumn vislevel="3">
    ...
    <Column x="0" y="2050" open="true" selected="false" sform="false" next="4" name="HB" caption="(BIG) darker in most directions combined with dark at the center">
      <Subcolumn vislevel="3">
    ...
    <Column x="0" y="1348" open="true" selected="false" sform="false" next="4" name="IB" caption="(BIG) THRESHOLD for &quot;dark enough&quot; test (useable range: 0.-255.)">
      <Subcolumn vislevel="3">
    ...
    <Column x="0" y="835" open="true" selected="false" sform="false" next="4" name="JB" caption="(BIG) NUMBER of directions to ignore in the &quot;darker in all but n directions&quot; test (useable range: 0-7)">
      <Subcolumn vislevel="3">
    ...
    <Column x="2081" y="0" open="true" selected="false" sform="false" next="7" name="AAA" caption="exclude small centroids too close to big centroids">
      <Subcolumn vislevel="3">
    ...
    <Column x="2973" y="0" open="true" selected="false" sform="false" next="22" name="Q" caption="(SMALL) disk mask">
      <Subcolumn vislevel="3">
    ...
    <Column x="0" y="2611" open="true" selected="false" sform="false" next="2" name="LB" caption="(SMALL) RADIUS of the inner disk">
      <Subcolumn vislevel="3">
    ...
    <Column x="0" y="2710" open="true" selected="false" sform="false" next="2" name="MB" caption="(SMALL) inner RADIUS of the outer ring">
      <Subcolumn vislevel="3">
    ...
    <Column x="0" y="2809" open="true" selected="false" sform="false" next="3" name="OB" caption="(SMALL) outer RADIUS of the outer ring">
      <Subcolumn vislevel="3">
    ...
    <Column x="4000" y="0" open="true" selected="false" sform="false" next="15" name="DB" caption="(SMALL) outer radius of ring">
      <Subcolumn vislevel="3">
    ...
    <Column x="4425" y="0" open="true" selected="false" sform="false" next="26" name="KB" caption="(SMALL) inner radius of ring">
      <Subcolumn vislevel="3">
    ...
    <Column x="8940" y="0" open="true" selected="false" sform="false" next="13" name="K" caption="(BIG) disk mask">
      <Subcolumn vislevel="3">
    ...
    <Column x="0" y="3007" open="true" selected="false" sform="false" next="2" name="NB" caption="(BIG) inner RADIUS of the outer ring">
      <Subcolumn vislevel="3">
    ...
    <Column x="0" y="2908" open="true" selected="false" sform="false" next="2" name="PB" caption="(BIG) RADIUS of the inner disk">
      <Subcolumn vislevel="3">
    ...
    <Column x="0" y="3106" open="true" selected="false" sform="false" next="2" name="QB" caption="(BIG) outer RADIUS of the outer ring">
      <Subcolumn vislevel="3">
    ...
    <Column x="9931" y="0" open="true" selected="false" sform="false" next="6" name="RB" caption="(BIG) outer radius of ring">
      <Subcolumn vislevel="3">
    ...
    <Column x="10354" y="0" open="true" selected="false" sform="false" next="13" name="SB" caption="(BIG) inner radius of ring">
      <Subcolumn vislevel="3">
        ...
        <Row popup="false" name="SB10">
          <Rhs vislevel="2" flags="5">
            <iImage window_x="0" window_y="0" window_width="1280" window_height="1024" image_left="9" image_top="6" image_mag="64" show_status="true" show_paintbox="false" show_convert="true" show_rulers="true" scale="1" offset="0" falsecolour="false" type="true"/>
            <Subcolumn vislevel="0"/>
    ...
    <Column x="0" y="463" open="true" selected="false" sform="false" next="1" name="ZZZZ" caption="THE MAIN ADJUSTABLE PARAMETERS ARE FOUND BELOW">
      <Subcolumn vislevel="3"/>
    </Column>
    <Column x="750" y="0" open="true" selected="false" sform="false" next="1" name="YYYY" caption="THE MAIN RESULTS ARE FOUND BELOW">
      <Subcolumn vislevel="3"/>
    </Column>
    <Column x="1582" y="0" open="true" selected="false" sform="false" next="1" name="XXXX" caption="THE MAIN COMPUTATION STEPS ARE FOUND TO THE RIGHT">
      <Subcolumn vislevel="3"/>
    </Column>
    <Column x="750" y="240" open="true" selected="true" sform="false" next="10" name="WWWW" caption="NICOLAS NEEDS TO ADD EASILY ACCESSED LISTS OF NANOPARTICLE COORDINATES">
      <Subcolumn vislevel="3">
    ...
    <Column x="0" y="2545" open="true" selected="false" sform="false" next="1" name="VVVV" caption="THE FOLLOWING PARAMETERS ARE GEOMETRICAL IN NATURE. HANDLE WITH CARE.">
      <Subcolumn vislevel="3"/>
    </Column>
  </Workspace>
</root>
